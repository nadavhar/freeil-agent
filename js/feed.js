...
function buildFeedEventCard(ev, isRecommended) {
    ...
    card.innerHTML = `
        ...
        <div class="card-body">
            ...
            <div class="card-footer">
                ...
                <div class="action-buttons">
                    <button class="action-btn comment-toggle-btn" title="תגובות">
                        💬 <span class="comment-count">0</span>
                    </button>
                    <button class="action-btn whatsapp-feed">${whatsappIcon}</button>
                </div>
            </div>
        </div>
    ...
    // Wire up whatsapp
    card.querySelector('.whatsapp-feed').addEventListener('click', e => {
        e.stopPropagation();
        shareToWhatsApp(ev);
    });
