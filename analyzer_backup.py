...
2. Focus on events in these cities: Tel Aviv (תל אביב), Rishon LeZion (ראשון לציון),
   Jerusalem (ירושלים). Include events from other Israeli cities only if clearly free.
...
- city: one of ["Tel Aviv", "Rishon LeZion", "Jerusalem", "Other"]
...
- event_type: one of ["concert", "festival", "market", "exhibition", "tour", "workshop",
  "sport", "community", "culture", "food", "nature", "nightlife", "family", "other"]
...
def analyze_events(raw_events):
    ...
    user_content = (
        ...
        "Focus on Tel Aviv, Rishon LeZion, and Jerusalem.\n\n"
    )
